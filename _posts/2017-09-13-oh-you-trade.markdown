...
Careers have been made in each of the 18 possiblities.  So it's not what you do, but how you do it.

In order, I've tried swing trading OTC, investing in equities, swing trading cryptocurrencies, and scalping options.  90% of my time has been spent scalping options.
...
Risk is premium paid.  Premium is composed of the underlying price relative to the contract strike, the underlying volatility, and the contract's time to expiration.  
...
1000/15000 = 6.6% return vs 1000/200 = 500% return
