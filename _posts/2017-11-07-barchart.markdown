...
*I am using the [BarChart.com OnDemand API][bc] to call getHistory() and receive up to 3 months of minute-level stock price data for a basket of stocks.  Then I do bar analysis to find potential buy spots.  This analysis is simply counting instances of minutely bars closing on highs.*
