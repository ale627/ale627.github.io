...
Here I find inside bars on the daily.
...
plt.plot(cut.index, cut.close, 'white', linewidth=3)
...
y1= exit_list['price']
#plot buys and sells
plt.plot(x,y,'g^', x1,y1,'rv', markersize=5.5)

#title
plt.title("$"+stock+" trades: "+start+" thru "+end, fontweight='bold', color='lightseagreen')
